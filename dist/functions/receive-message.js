        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    (0, helper_1.print)("[".concat(consumer_name, "] Handling message: ").concat(message.getData().toString(), " \n              => Delivery : ").concat(message.getRedeliveryCount(), "/").concat(config.producer.max_redelivery, "\n              => Topic: ").concat(message.getTopicName(), "\n              => Partition: ").concat(message.getPartitionKey()));
                    _b.label = 1;
                case 1:
                    _b.trys.push([1, 7, , 8]);
                    _a = config.consumers.mock_nack;
                    if (!_a) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, helper_1.mock_nack)(message, config.producer.max_redelivery)];
                case 2:
                    _a = (_b.sent());
                    _b.label = 3;
                case 3:
